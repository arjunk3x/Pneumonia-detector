...
<head>
  <style>
    ...
    /* Increased size for ART/Delivery and Sponsor */
    .initial-label-large {
        font-size:1rem;
        font-weight:600;
    ...
    .initial-grid-3 { display:grid; grid-template-columns:repeat(3,minmax(0,1fr)); gap:1.5rem; }
...
<div class="initial-wrapper">
  ...
  <!-- HEADER -->
  <div class="initial-header-card" style="--initial-background:#ffe7d6;">
    <div>
...
""".format(
    art_delivery, sid, current_stage,
    s_row.get("Sponsor","-"),
    amount, overall_bg, overall,
    risk_bg, risk_level,
    submitted, requester, department
)
